...
class InputScoreDialog:
    ...
    def create_ui(self):
        ...
        self.weight_entry.bind("<Return>", lambda e: self.mssv_entry.focus())
        ...
        self.name_label = tk.Label(frame, text="", width=24, anchor="w")
        ...
        self.weight_sum_label = tk.Label(self.win, font=("Arial", 10, "bold"))
    ...
    def autofill_weight(self, event=None):
        ...
        if column in self.weights:
            ...
            self.weight_entry.insert(0, str(self.weights[column]))
    ...
    def save(self, event=None):
        ...
        if not validate_score(score_text):
            messagebox.showerror("Error", "Điểm phải từ 0 đến 10")
            return
    ...
    def update_weight_sum(self):
        ...
        self.weight_sum_label.config(text=text, fg=color)
